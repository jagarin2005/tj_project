          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <div class="col-md-12">
                ...
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="r_type2" id="r_type2_3" value="อุปกรณ์">
                  <label class="form-check-label mr-3" for="r_type2_3">
                    อื่นๆ
                  </label>
                  <input class="form-control" type="text" name="r_type2_desc" id="r_type2_desc" value="อื่นๆ" placeholder="">
                </div>
              </div>
            </div>
          </div>
